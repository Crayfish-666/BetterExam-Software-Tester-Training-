...
技术栈：React 18 + Vite + Tailwind CSS + Node.js (Express) + SQLite3

项目描述：独立开发的一款追求极致用户体验的现代化刷题与查阅系统。题目来源是逆向学校刷题软件弄出来的题库，因学校软件过于反人类，操作繁琐不易用，遂有此项目。本系统摈弃了传统的枯燥排版，采用拟物化毛玻璃设计，致力于为用户提供媲美大型机考（如雅思、托福）的流畅体验。
